...
void stackWall(float size, float R, float G, float B, float alpha) {
	jhm::position p1(-size, -size, -size);
	jhm::position p2(size, -size, -size);
	jhm::position p3(size, size, -size);
	jhm::position p4(-size, size, -size);
	jhm::position p5(-size, size, size);
	jhm::position p6(-size, -size, size);
	jhm::position p7(size, -size, size);

	jhm::vector v1(0, 0, 1);
	jhm::vector v2(1, 0, 0);
	jhm::vector v3(0, 1, 0);

	Triangle t1(p1, p2, p3, v1, v1, v1, R, G, B, alpha);
	Triangle t2(p1, p3, p4, v1, v1, v1, R, G, B ,alpha);
	Triangle t3(p1, p4, p5, v2, v2, v2, R, G, B, alpha);
	Triangle t4(p1, p5, p6, v2, v2, v2, R, G, B, alpha);
	Triangle t5(p1, p6, p7, v3, v3, v3, R, G, B, alpha);
	Triangle t6(p1, p7, p2, v3, v3, v3, R, G, B, alpha);
