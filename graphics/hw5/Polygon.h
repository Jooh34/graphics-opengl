...
public:
  ...
  jhm::vector N;
	...
	Polygon(jhm::position p1, jhm::position p2, jhm::position p3, jhm::vector ka, jhm::vector kd, jhm::vector ks, float kn, float reflectivity, float transparency, float n);
